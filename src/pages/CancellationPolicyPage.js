...
import CancellationPeriod from "../components/CancellationPeriod";
...
const CancellationPolicyPage = () => {
  return (
    <div className="cancellationpolicypage">
      <NavBar />
      <section className="cancellation-policy-title">
      ...
      <section className="cancellation-policy-content">
        <CancellationPeriod />
        <div className="refund-eligibility">
          ...
          <div className="refund-eligibility-content">
